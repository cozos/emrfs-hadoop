...
public final class EmrFsStore$MetadataFile
  ...
  implements EmrFsStore.MetadataFileOrBuilder
{
  ...
  private EmrFsStore$MetadataFile(GeneratedMessage.Builder<?> builder)
  {
    super(builder);
    unknownFields = builder.getUnknownFields();
  }
  
  private EmrFsStore$MetadataFile(boolean noInit)
  {
  ...
  private EmrFsStore$MetadataFile(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
  ...
  {
    return 
      EmrFsStore.access$100().ensureFieldAccessorsInitialized(MetadataFile.class, Builder.class);
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.EmrFsStore.MetadataFile
