  ...
  implements FieldElement<BigFraction>, Comparable<BigFraction>, Serializable
{
  ...
  private static final String FORBIDDEN_ZERO_DENOMINATOR = "denominator must be different from 0";
  ...
  {
    if (num == null) {
      throw MathRuntimeException.createNullPointerException("numerator is null", new Object[0]);
    }
    if (den == null) {
      throw MathRuntimeException.createNullPointerException("denominator is null", new Object[0]);
    }
    if (BigInteger.ZERO.equals(den)) {
      throw MathRuntimeException.createArithmeticException("denominator must be different from 0", new Object[0]);
    }
    ...
    throws IllegalArgumentException
  {
    if (Double.isNaN(value)) {
      throw MathRuntimeException.createIllegalArgumentException("cannot convert NaN value", new Object[0]);
    }
    if (Double.isInfinite(value)) {
      throw MathRuntimeException.createIllegalArgumentException("cannot convert infinite value", new Object[0]);
    }
  ...
  {
    return Math.pow(numerator.doubleValue(), exponent) / Math.pow(denominator.doubleValue(), exponent);
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.fraction.BigFraction
