...
public class StringUtils
{
  ...
  private static String replaceEach(String text, String[] searchList, String[] replacementList, boolean repeat, int timeToLive)
  {
    ...
    for (int i = 0; i < searchLength; i++) {
      if ((noMoreMatchesForReplIndex[i] == 0) && (searchList[i] != null) && (!searchList[i].isEmpty()) && (replacementList[i] != null))
      {
  ...
  public static String uncapitalize(String str)
  {
    ...
    return strLen + Character.toLowerCase(firstChar) + str.substring(1);
  }
  ...
  private static double score(CharSequence first, CharSequence second)
  {
    ...
    {
      String longer = first.toString().toLowerCase();
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.lang3.StringUtils
