  ...
  implements Serializable
{
  ...
  public Rotation(double q0, double q1, double q2, double q3, boolean needsNormalization)
  {
    ...
    {
      double inv = 1.0D / Math.sqrt(q0 * q0 + q1 * q1 + q2 * q2 + q3 * q3);
      q0 *= inv;
      q1 *= inv;
      q2 *= inv;
      q3 *= inv;
  ...
  public Rotation(Vector3D axis, double angle)
  {
    ...
    if (norm == 0.0D) {
      throw MathRuntimeException.createArithmeticException("zero norm for rotation axis", new Object[0]);
    }
    ...
    throws NotARotationMatrixException
  {
    if ((m.length != 3) || (m[0].length != 3) || (m[1].length != 3) || (m[2].length != 3)) {
      throw new NotARotationMatrixException("a {0}x{1} matrix cannot be a rotation matrix", new Object[] { Integer.valueOf(m.length), Integer.valueOf(m[0].length) });
    }
    ...
    if (det < 0.0D) {
      throw new NotARotationMatrixException("the closest orthogonal matrix has a negative determinant {0}", new Object[] { Double.valueOf(det) });
    }
    double s = ort[0][0] + ort[1][1] + ort[2][2];
    if (s > -0.19D)
    {
      q0 = (0.5D * Math.sqrt(s + 1.0D));
      double inv = 0.25D / q0;
  ...
  public Rotation(Vector3D u1, Vector3D u2, Vector3D v1, Vector3D v2)
  {
    ...
    if ((u1u1 == 0.0D) || (u2u2 == 0.0D) || (v1v1 == 0.0D) || (v2v2 == 0.0D)) {
      throw MathRuntimeException.createIllegalArgumentException("zero norm for rotation defining vector", new Object[0]);
    }
    double u1x = u1.getX();
    double u1y = u1.getY();
    double u1z = u1.getZ();
  ...
  public Rotation(Vector3D u, Vector3D v)
  {
    ...
    {
      q0 = Math.sqrt(0.5D * (1.0D + dot / normProduct));
  ...
  public Vector3D getAxis()
  {
    ...
    if (q0 < 0.0D)
    {
      double inverse = 1.0D / Math.sqrt(squaredSine);
  ...
  {
    if ((q0 < -0.1D) || (q0 > 0.1D)) {
      return 2.0D * Math.asin(Math.sqrt(q1 * q1 + q2 * q2 + q3 * q3));
    }
    if (q0 < 0.0D) {
      return 2.0D * Math.acos(-q0);
    }
    return 2.0D * Math.acos(q0);
  }
    ...
    throws CardanEulerSingularityException
  {
    if (order == RotationOrder.XYZ)
    {
      ...
      return new double[] { Math.atan2(-v1.getY(), v1.getZ()), Math.asin(v2.getZ()), Math.atan2(-v2.getY(), v2.getX()) };
    }
    if (order == RotationOrder.XZY)
    {
      ...
      return new double[] { Math.atan2(v1.getZ(), v1.getY()), -Math.asin(v2.getY()), Math.atan2(v2.getZ(), v2.getX()) };
    }
    if (order == RotationOrder.YXZ)
    {
      ...
      return new double[] { Math.atan2(v1.getX(), v1.getZ()), -Math.asin(v2.getZ()), Math.atan2(v2.getX(), v2.getY()) };
    }
    if (order == RotationOrder.YZX)
    {
      ...
      return new double[] { Math.atan2(-v1.getZ(), v1.getX()), Math.asin(v2.getX()), Math.atan2(-v2.getZ(), v2.getY()) };
    }
    if (order == RotationOrder.ZXY)
    {
      ...
      return new double[] { Math.atan2(-v1.getX(), v1.getY()), Math.asin(v2.getY()), Math.atan2(-v2.getX(), v2.getZ()) };
    }
    if (order == RotationOrder.ZYX)
    {
      ...
      return new double[] { Math.atan2(v1.getY(), v1.getX()), -Math.asin(v2.getX()), Math.atan2(v2.getY(), v2.getZ()) };
    }
    if (order == RotationOrder.XYX)
    {
      ...
      return new double[] { Math.atan2(v1.getY(), -v1.getZ()), Math.acos(v2.getX()), Math.atan2(v2.getY(), v2.getZ()) };
    }
    if (order == RotationOrder.XZX)
    {
      ...
      return new double[] { Math.atan2(v1.getZ(), v1.getY()), Math.acos(v2.getX()), Math.atan2(v2.getZ(), -v2.getY()) };
    }
    if (order == RotationOrder.YXY)
    {
      ...
      return new double[] { Math.atan2(v1.getX(), v1.getZ()), Math.acos(v2.getY()), Math.atan2(v2.getX(), -v2.getZ()) };
    }
    if (order == RotationOrder.YZY)
    {
      ...
      return new double[] { Math.atan2(v1.getZ(), -v1.getX()), Math.acos(v2.getY()), Math.atan2(v2.getZ(), v2.getX()) };
    }
    if (order == RotationOrder.ZXZ)
    {
      ...
      return new double[] { Math.atan2(v1.getX(), -v1.getY()), Math.acos(v2.getZ()), Math.atan2(v2.getX(), v2.getY()) };
    }
    Vector3D v1 = applyTo(Vector3D.PLUS_K);
    Vector3D v2 = applyInverseTo(Vector3D.PLUS_K);
    if ((v2.getZ() < -0.9999999999D) || (v2.getZ() > 0.9999999999D)) {
    ...
    return new double[] { Math.atan2(v1.getY(), v1.getX()), Math.acos(v2.getZ()), Math.atan2(v2.getY(), -v2.getX()) };
  }
    ...
    throws NotARotationMatrixException
  {
    ...
    throw new NotARotationMatrixException("unable to orthogonalize matrix in {0} iterations", new Object[] { Integer.valueOf(i - 1) });
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.geometry.Rotation
