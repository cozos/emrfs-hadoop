  ...
  implements FieldMatrix<T>
{
  ...
  {
    if (rowDimension <= 0) {
      throw MathRuntimeException.createIllegalArgumentException("invalid row dimension {0} (must be positive)", new Object[] { Integer.valueOf(rowDimension) });
    }
    if (columnDimension <= 0) {
      throw MathRuntimeException.createIllegalArgumentException("invalid column dimension {0} (must be positive)", new Object[] { Integer.valueOf(columnDimension) });
    }
    this.field = field;
  }
    ...
    throws MatrixIndexException, IllegalArgumentException
  {
    ...
    if ((destination.length < rowsCount) || (destination[0].length < columnsCount)) {
      throw MathRuntimeException.createIllegalArgumentException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new Object[] { Integer.valueOf(destination.length), Integer.valueOf(destination[0].length), Integer.valueOf(rowsCount), Integer.valueOf(columnsCount) });
    }
    ...
    throws MatrixIndexException, IllegalArgumentException
  {
    ...
    if ((destination.length < selectedRows.length) || (destination[0].length < selectedColumns.length)) {
      throw MathRuntimeException.createIllegalArgumentException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new Object[] { Integer.valueOf(destination.length), Integer.valueOf(destination[0].length), Integer.valueOf(selectedRows.length), Integer.valueOf(selectedColumns.length) });
    }
    ...
    throws MatrixIndexException
  {
    ...
    for (int r = 1; r < nRows; r++) {
      if (subMatrix[r].length != nCols) {
        throw MathRuntimeException.createIllegalArgumentException("some rows have length {0} while others have length {1}", new Object[] { Integer.valueOf(nCols), Integer.valueOf(subMatrix[r].length) });
      }
    }
    checkRowIndex(row);
    ...
    throws MatrixIndexException, InvalidMatrixException
  {
    ...
    if ((matrix.getRowDimension() != 1) || (matrix.getColumnDimension() != nCols)) {
      throw new InvalidMatrixException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new Object[] { Integer.valueOf(matrix.getRowDimension()), Integer.valueOf(matrix.getColumnDimension()), Integer.valueOf(1), Integer.valueOf(nCols) });
    }
    for (int i = 0; i < nCols; i++) {
    ...
    throws MatrixIndexException, InvalidMatrixException
  {
    ...
    if ((matrix.getRowDimension() != nRows) || (matrix.getColumnDimension() != 1)) {
      throw new InvalidMatrixException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new Object[] { Integer.valueOf(matrix.getRowDimension()), Integer.valueOf(matrix.getColumnDimension()), Integer.valueOf(nRows), Integer.valueOf(1) });
    }
    for (int i = 0; i < nRows; i++) {
    ...
    throws MatrixIndexException, InvalidMatrixException
  {
    ...
    if (vector.getDimension() != nCols) {
      throw new InvalidMatrixException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new Object[] { Integer.valueOf(1), Integer.valueOf(vector.getDimension()), Integer.valueOf(1), Integer.valueOf(nCols) });
    }
    for (int i = 0; i < nCols; i++) {
    ...
    throws MatrixIndexException, InvalidMatrixException
  {
    ...
    if (vector.getDimension() != nRows) {
      throw new InvalidMatrixException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new Object[] { Integer.valueOf(vector.getDimension()), Integer.valueOf(1), Integer.valueOf(nRows), Integer.valueOf(1) });
    }
    for (int i = 0; i < nRows; i++) {
    ...
    throws MatrixIndexException, InvalidMatrixException
  {
    ...
    if (array.length != nCols) {
      throw new InvalidMatrixException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new Object[] { Integer.valueOf(1), Integer.valueOf(array.length), Integer.valueOf(1), Integer.valueOf(nCols) });
    }
    for (int i = 0; i < nCols; i++) {
    ...
    throws MatrixIndexException, InvalidMatrixException
  {
    ...
    if (array.length != nRows) {
      throw new InvalidMatrixException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new Object[] { Integer.valueOf(array.length), Integer.valueOf(1), Integer.valueOf(nRows), Integer.valueOf(1) });
    }
    for (int i = 0; i < nRows; i++) {
    ...
    throws IllegalArgumentException
  {
    ...
    catch (ClassCastException cce)
    {
      ...
      if (v.getDimension() != nCols) {
        throw MathRuntimeException.createIllegalArgumentException("vector length mismatch: got {0} but expected {1}", new Object[] { Integer.valueOf(v.getDimension()), Integer.valueOf(nCols) });
      }
      T[] out = buildArray(field, nRows);
      for (int row = 0; row < nRows; row++)
      {
    ...
    throws IllegalArgumentException
  {
    ...
    catch (ClassCastException cce)
    {
      ...
      if (v.getDimension() != nRows) {
        throw MathRuntimeException.createIllegalArgumentException("vector length mismatch: got {0} but expected {1}", new Object[] { Integer.valueOf(v.getDimension()), Integer.valueOf(nRows) });
      }
      T[] out = buildArray(field, nCols);
      for (int col = 0; col < nCols; col++)
      {
  ...
  protected void checkRowIndex(int row)
  {
    if ((row < 0) || (row >= getRowDimension())) {
      throw new MatrixIndexException("row index {0} out of allowed range [{1}, {2}]", new Object[] { Integer.valueOf(row), Integer.valueOf(0), Integer.valueOf(getRowDimension() - 1) });
    }
  }
    ...
    throws MatrixIndexException
  {
    if ((column < 0) || (column >= getColumnDimension())) {
      throw new MatrixIndexException("column index {0} out of allowed range [{1}, {2}]", new Object[] { Integer.valueOf(column), Integer.valueOf(0), Integer.valueOf(getColumnDimension() - 1) });
    }
  }
  ...
  protected void checkSubMatrixIndex(int startRow, int endRow, int startColumn, int endColumn)
  {
    ...
    if (startRow > endRow) {
      throw new MatrixIndexException("initial row {0} after final row {1}", new Object[] { Integer.valueOf(startRow), Integer.valueOf(endRow) });
    }
    checkColumnIndex(startColumn);
    checkColumnIndex(endColumn);
    if (startColumn > endColumn) {
      throw new MatrixIndexException("initial column {0} after final column {1}", new Object[] { Integer.valueOf(startColumn), Integer.valueOf(endColumn) });
    }
  }
  ...
  protected void checkAdditionCompatible(FieldMatrix<T> m)
  {
    if ((getRowDimension() != m.getRowDimension()) || (getColumnDimension() != m.getColumnDimension())) {
      throw MathRuntimeException.createIllegalArgumentException("{0}x{1} and {2}x{3} matrices are not addition compatible", new Object[] { Integer.valueOf(getRowDimension()), Integer.valueOf(getColumnDimension()), Integer.valueOf(m.getRowDimension()), Integer.valueOf(m.getColumnDimension()) });
    }
  }
  ...
  {
    if ((getRowDimension() != m.getRowDimension()) || (getColumnDimension() != m.getColumnDimension())) {
      throw MathRuntimeException.createIllegalArgumentException("{0}x{1} and {2}x{3} matrices are not subtraction compatible", new Object[] { Integer.valueOf(getRowDimension()), Integer.valueOf(getColumnDimension()), Integer.valueOf(m.getRowDimension()), Integer.valueOf(m.getColumnDimension()) });
    }
  }
  ...
  protected void checkMultiplicationCompatible(FieldMatrix<T> m)
  {
    if (getColumnDimension() != m.getRowDimension()) {
      throw MathRuntimeException.createIllegalArgumentException("{0}x{1} and {2}x{3} matrices are not multiplication compatible", new Object[] { Integer.valueOf(getRowDimension()), Integer.valueOf(getColumnDimension()), Integer.valueOf(m.getRowDimension()), Integer.valueOf(m.getColumnDimension()) });
    }
  }
}

/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.linear.AbstractFieldMatrix
