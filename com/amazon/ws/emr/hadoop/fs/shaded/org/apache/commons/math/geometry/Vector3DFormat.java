  ...
  extends CompositeFormat
{
  ...
  public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos)
  {
    ...
    throw MathRuntimeException.createIllegalArgumentException("cannot format a {0} instance as a 3D vector", new Object[] { obj.getClass().getName() });
  }
    ...
    throws ParseException
  {
    ...
    if (parsePosition.getIndex() == 0) {
      throw MathRuntimeException.createParseException(parsePosition.getErrorIndex(), "unparseable 3D vector: \"{0}\"", new Object[] { source });
    }
    return result;
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.geometry.Vector3DFormat
