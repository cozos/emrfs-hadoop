...
public class MatrixUtils
{
  ...
  public static <T extends FieldElement<T>> FieldMatrix<T> createFieldMatrix(com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.Field<T> field, int rows, int columns)
  {
  ...
  public static <T extends FieldElement<T>> FieldMatrix<T> createFieldIdentityMatrix(com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.Field<T> field, int dimension)
  {
  ...
  public static void checkRowIndex(AnyMatrix m, int row)
  {
    if ((row < 0) || (row >= m.getRowDimension())) {
      throw new MatrixIndexException("row index {0} out of allowed range [{1}, {2}]", new Object[] { Integer.valueOf(row), Integer.valueOf(0), Integer.valueOf(m.getRowDimension() - 1) });
    }
  }
    ...
    throws MatrixIndexException
  {
    if ((column < 0) || (column >= m.getColumnDimension())) {
      throw new MatrixIndexException("column index {0} out of allowed range [{1}, {2}]", new Object[] { Integer.valueOf(column), Integer.valueOf(0), Integer.valueOf(m.getColumnDimension() - 1) });
    }
  }
    ...
    throws IllegalArgumentException
  {
    if ((left.getRowDimension() != right.getRowDimension()) || (left.getColumnDimension() != right.getColumnDimension())) {
      throw MathRuntimeException.createIllegalArgumentException("{0}x{1} and {2}x{3} matrices are not addition compatible", new Object[] { Integer.valueOf(left.getRowDimension()), Integer.valueOf(left.getColumnDimension()), Integer.valueOf(right.getRowDimension()), Integer.valueOf(right.getColumnDimension()) });
    }
  }
  ...
  {
    if ((left.getRowDimension() != right.getRowDimension()) || (left.getColumnDimension() != right.getColumnDimension())) {
      throw MathRuntimeException.createIllegalArgumentException("{0}x{1} and {2}x{3} matrices are not subtraction compatible", new Object[] { Integer.valueOf(left.getRowDimension()), Integer.valueOf(left.getColumnDimension()), Integer.valueOf(right.getRowDimension()), Integer.valueOf(right.getColumnDimension()) });
    }
  }
    ...
    throws IllegalArgumentException
  {
    if (left.getColumnDimension() != right.getRowDimension()) {
      throw MathRuntimeException.createIllegalArgumentException("{0}x{1} and {2}x{3} matrices are not multiplication compatible", new Object[] { Integer.valueOf(left.getRowDimension()), Integer.valueOf(left.getColumnDimension()), Integer.valueOf(right.getRowDimension()), Integer.valueOf(right.getColumnDimension()) });
    }
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.linear.MatrixUtils
