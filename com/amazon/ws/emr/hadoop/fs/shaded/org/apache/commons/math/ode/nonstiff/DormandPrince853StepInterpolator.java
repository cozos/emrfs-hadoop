  ...
  extends RungeKuttaStepInterpolator
{
    ...
    throws DerivativeException
  {
    ...
    integrator.computeDerivatives(previousTime + 0.1D * h, yTmp, yDotKLast[0]);
    for (int j = 0; j < currentState.length; j++)
    {
    ...
    integrator.computeDerivatives(previousTime + 0.2D * h, yTmp, yDotKLast[1]);
    for (int j = 0; j < currentState.length; j++)
    {
    ...
    integrator.computeDerivatives(previousTime + 0.7777777777777778D * h, yTmp, yDotKLast[2]);
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator
