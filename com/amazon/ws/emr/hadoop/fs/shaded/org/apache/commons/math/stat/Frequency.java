  ...
  implements Serializable
{
  ...
  public void addValue(Object v)
  {
    if ((v instanceof Comparable)) {
      ...
      throw MathRuntimeException.createIllegalArgumentException("class ({0}) does not implement Comparable", new Object[] { v.getClass().getName() });
    }
  }
  ...
  public void addValue(Comparable<?> v)
  {
    ...
    {
      throw MathRuntimeException.createIllegalArgumentException("instance of class {0} not comparable to existing values", new Object[] { v.getClass().getName() });
    }
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.stat.Frequency
