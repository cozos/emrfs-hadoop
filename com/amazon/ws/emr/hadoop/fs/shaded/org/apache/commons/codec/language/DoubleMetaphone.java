  ...
  implements StringEncoder
{
  ...
  private int handleC(String value, DoubleMetaphoneResult result, int index)
  {
    ...
    {
      if (index == 0) {
        if (contains(value, index, 6, new String[] { "CAESAR" }))
        {
          result.append('S');
      ...
      {
        if (contains(value, index, 2, new String[] { "CZ" })) {
          if (!contains(value, index - 2, 4, new String[] { "WICZ" }))
          {
            result.append('S', 'X');
            index += 2; return index;
          }
        ...
        else
        {
          ...
          else
          {
            ...
            {
              if (contains(value, index + 1, 1, new String[] { "C", "K", "Q" })) {
                if (!contains(value, index + 1, 2, new String[] { "CE", "CI" }))
                {
                  index += 2; return index;
                }
              }
  ...
  {
    if (contains(value, index + 2, 1, new String[] { "I", "E", "H" })) {
      if (!contains(value, index + 2, 2, new String[] { "HU" }))
      {
        if ((index != 1) || (charAt(value, index - 1) != 'A'))
        {
          if (!contains(value, index - 1, 5, new String[] { "UCCEE", "UCCES" })) {}
        }
        else
        {
          result.append("KS");
  ...
  {
    if (index > 0) {
      if (contains(value, index, 4, new String[] { "CHAE" }))
      {
        result.append('K', 'X');
        return index + 2;
      }
  ...
  private int handleG(String value, DoubleMetaphoneResult result, int index, boolean slavoGermanic)
  {
    ...
    {
      if ((contains(value, index + 1, 2, new String[] { "ER" })) || (charAt(value, index + 1) == 'Y')) {
        if (!contains(value, 0, 6, new String[] { "DANGER", "RANGER", "MANGER" })) {
          if (!contains(value, index - 1, 1, new String[] { "E", "I" })) {
            if (!contains(value, index - 1, 3, new String[] { "RGY", "OGY" }))
            {
              result.append('K', 'J');
              index += 2; return index;
            }
      ...
      if (!contains(value, index + 1, 1, new String[] { "E", "I", "Y" }))
      {
        if (!contains(value, index - 1, 4, new String[] { "AGGI", "OGGI" })) {}
      }
      else
      {
        if (!contains(value, 0, 4, new String[] { "VAN ", "VON " })) {
          if (!contains(value, 0, 3, new String[] { "SCH" })) {
            if (!contains(value, index + 1, 2, new String[] { "ET" })) {
              break label489;
            }
          }
        }
  ...
  private int handleGH(String value, DoubleMetaphoneResult result, int index)
  {
    ...
    else
    {
      if (index > 1)
      {
        if (contains(value, index - 2, 1, new String[] { "B", "H", "D" })) {}
      }
      else if (index > 2)
      {
        if (contains(value, index - 3, 1, new String[] { "B", "H", "D" })) {}
      }
      else
      {
        if (index <= 3) {
        ...
        if (!contains(value, index - 4, 1, new String[] { "B", "H" })) {
          break label180;
        }
      }
      index += 2; return index;
      ...
      if ((index > 2) && (charAt(value, index - 1) == 'U')) {
        if (contains(value, index - 3, 1, new String[] { "C", "G", "L", "R", "T" }))
        {
          result.append('F');
          break label274;
        }
  ...
  {
    if (!contains(value, index, 4, new String[] { "JOSE" }))
    {
      if (!contains(value, 0, 4, new String[] { "SAN " })) {}
    }
    else
    {
    ...
    if ((isVowel(charAt(value, index - 1))) && (!slavoGermanic) && ((charAt(value, index + 1) == 'A') || (charAt(value, index + 1) == 'O'))) {
      ...
      if (!contains(value, index - 1, 1, new String[] { "S", "K", "L" })) {
        result.append('J');
      }
    }
    label269:
  ...
  private int handleP(String value, DoubleMetaphoneResult result, int index)
  {
    ...
    {
      result.append('P');
      index = contains(value, index + 1, 1, tmp46_40) ? index + 2 : index + 1;
    }
    return index;
  }
  ...
  private int handleR(String value, DoubleMetaphoneResult result, int index, boolean slavoGermanic)
  {
    if ((index == value.length() - 1) && (!slavoGermanic)) {
      if (contains(value, index - 2, 2, new String[] { "IE" })) {
        if (!contains(value, index - 4, 2, new String[] { "ME", "MA" }))
        {
  ...
  private int handleS(String value, DoubleMetaphoneResult result, int index, boolean slavoGermanic)
  {
    ...
    {
      if (index == 0) {
        if (contains(value, index, 5, new String[] { "SUGAR" }))
        {
          result.append('X', 'S');
          index++; return index;
        }
      ...
      {
        if (!contains(value, index, 3, new String[] { "SIO", "SIA" }))
        {
          if (!contains(value, index, 4, new String[] { "SIAN" })) {}
        }
        else
        {
          if (slavoGermanic) {
        ...
        if (index == 0)
        {
          if (contains(value, index + 1, 1, new String[] { "M", "N", "L", "W" })) {}
        }
        else {
          if (!contains(value, index + 1, 1, new String[] { "Z" })) {
            break label327;
          }
        }
        result.append('S', 'X');
        index = contains(value, index + 1, 1, tmp302_299) ? index + 2 : index + 1; return index;
        label327:
        ...
        else
        {
          if (index == value.length() - 1) {
            if (contains(value, index - 2, 2, new String[] { "AI", "OI" }))
            {
          ...
          result.append('S');
          label409:
          index = contains(value, index + 1, 1, tmp424_418) ? index + 2 : index + 1;
        }
      }
    }
    return index;
  ...
  private int handleT(String value, DoubleMetaphoneResult result, int index)
  {
    ...
    {
      if (!contains(value, index, 2, new String[] { "TH" }))
      {
        if (!contains(value, index, 3, new String[] { "TTH" })) {}
      }
      else
      {
        if (!contains(value, index + 2, 2, new String[] { "OM", "AM" })) {
          if (!contains(value, 0, 4, new String[] { "VAN ", "VON " })) {
            if (!contains(value, 0, 3, new String[] { "SCH" })) {
              break label186;
            }
      ...
      result.append('T');
      index = contains(value, index + 1, 1, tmp221_215) ? index + 2 : index + 1;
    }
    return index;
  }
  ...
  private int handleW(String value, DoubleMetaphoneResult result, int index)
  {
    ...
    else
    {
      if (index == 0) {
        ...
        {
          if (!contains(value, index, 2, new String[] { "WH" })) {}
        }
        else
        {
          if (isVowel(charAt(value, index + 1))) {
      ...
      if ((index != value.length() - 1) || (!isVowel(charAt(value, index - 1)))) {
        if (!contains(value, index - 1, 5, new String[] { "EWSKI", "EWSKY", "OWSKI", "OWSKY" })) {
          if (!contains(value, 0, 3, new String[] { "SCH" })) {
            break label202;
          }
        }
  ...
  private int handleX(String value, DoubleMetaphoneResult result, int index)
  {
    ...
    else
    {
      if (index == value.length() - 1)
      {
        if (!contains(value, index - 3, 3, new String[] { "IAU", "EAU" })) {
          if (contains(value, index - 2, 2, new String[] { "AU", "OU" })) {}
        }
      }
      else {
        result.append("KS");
      }
      index = contains(value, index + 1, 1, tmp100_95) ? index + 2 : index + 1;
    }
    return index;
  }
  ...
  private boolean conditionC0(String value, int index)
  {
    ...
    if ((c == 'I') || (c == 'E')) {}
    return contains(value, index - 2, 6, new String[] { "BACHER", "MACHER" });
  }
  ...
  private boolean conditionCH0(String value, int index)
  {
    ...
    if (!contains(value, index + 1, 5, new String[] { "HARAC", "HARIS" })) {
      if (!contains(value, index + 1, 3, new String[] { "HOR", "HYM", "HIA", "HEM" })) {
        return false;
      }
    }
  ...
  private boolean conditionCH1(String value, int index)
  {
    if (!contains(value, 0, 4, new String[] { "VAN ", "VON " })) {
      if (!contains(value, 0, 3, new String[] { "SCH" })) {
        if (!contains(value, index - 2, 6, new String[] { "ORCHES", "ARCHIT", "ORCHID" })) {
          if (contains(value, index + 2, 1, new String[] { "T", "S" })) {}
        }
      }
    }
    return ((contains(value, index - 1, 1, new String[] { "A", "O", "U", "E" })) || (index == 0)) && ((contains(value, index + 2, 1, L_R_N_M_B_H_F_V_W_SPACE)) || (index + 1 == value.length() - 1));
  }
  
  private boolean conditionL0(String value, int index)
  {
    if (index == value.length() - 3) {
      if (contains(value, index - 1, 4, new String[] { "ILLO", "ILLA", "ALLE" })) {
        return true;
      }
    }
    if (!contains(value, value.length() - 2, 2, new String[] { "AS", "OS" }))
    {
      if (!contains(value, value.length() - 1, 1, new String[] { "A", "O" })) {}
    }
    else if (contains(value, index - 1, 4, new String[] { "ALLE" })) {
      return true;
    }
    return false;
  }
  ...
  private boolean conditionM0(String value, int index)
  {
    ...
    if (contains(value, index - 1, 3, new String[] { "UMB" })) {
      if (index + 1 == value.length() - 1) {}
    }
    return contains(value, index + 2, 2, new String[] { "ER" });
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.codec.language.DoubleMetaphone
