    ...
    else
    {
      ...
      else
      {
        ...
        for (int i = 0; i < errfac.length; i++)
        {
          ...
          double e = 0.5D * Math.sqrt((i + 1) / ip5);
          for (int j = 0; j <= i; j++) {
            errfac[i] *= e / (j + 1);
          }
        }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.ode.nonstiff.GraggBulirschStoerStepInterpolator
