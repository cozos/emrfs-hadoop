...
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.analysis.BinaryFunction;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.analysis.ComposableFunction;
  ...
  implements RealVector
{
    ...
    throws IllegalArgumentException
  {
    ...
    if (d != n) {
      throw MathRuntimeException.createIllegalArgumentException("vector length mismatch: got {0} but expected {1}", new Object[] { Double.valueOf(d), Integer.valueOf(n) });
    }
  }
    ...
    throws MatrixIndexException
  {
    if ((index < 0) || (index >= getDimension())) {
      throw new MatrixIndexException("index {0} out of allowed range [{1}, {2}]", new Object[] { Integer.valueOf(index), Integer.valueOf(0), Integer.valueOf(getDimension() - 1) });
    }
  }
    ...
    throws IllegalArgumentException
  {
    ...
    for (; (thisIt.hasNext()) && ((thisE = (RealVector.Entry)thisIt.next()) != null); goto 96)
    {
    ...
    implements Iterator<RealVector.Entry>
  {
    ...
    private AbstractRealVector.EntryImpl tmp = new AbstractRealVector.EntryImpl(AbstractRealVector.this);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.linear.AbstractRealVector
