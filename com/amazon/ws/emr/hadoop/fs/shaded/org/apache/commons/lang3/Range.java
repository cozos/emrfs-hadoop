  ...
  implements Serializable
{
  ...
  public boolean containsRange(Range<T> otherRange)
  {
    ...
    return (contains(minimum)) && (contains(maximum));
  }
  ...
  public boolean isOverlappedBy(Range<T> otherRange)
  {
    ...
    return (otherRange.contains(minimum)) || (otherRange.contains(maximum)) || (contains(minimum));
  }
  ...
  public boolean equals(Object obj)
  {
    ...
    return (minimum.equals(minimum)) && (maximum.equals(maximum));
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.lang3.Range
