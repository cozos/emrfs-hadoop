  ...
  implements FieldElement<Fraction>, Comparable<Fraction>, Serializable
{
  ...
  {
    if (den == 0) {
      throw MathRuntimeException.createArithmeticException("zero denominator in fraction {0}/{1}", new Object[] { Integer.valueOf(num), Integer.valueOf(den) });
    }
    if (den < 0)
    {
      if ((num == Integer.MIN_VALUE) || (den == Integer.MIN_VALUE)) {
        throw MathRuntimeException.createArithmeticException("overflow in fraction {0}/{1}, cannot negate", new Object[] { Integer.valueOf(num), Integer.valueOf(den) });
      }
      num = -num;
      den = -den;
    }
  ...
  public Fraction negate()
  {
    if (numerator == Integer.MIN_VALUE) {
      throw MathRuntimeException.createArithmeticException("overflow in fraction {0}/{1}, cannot negate", new Object[] { Integer.valueOf(numerator), Integer.valueOf(denominator) });
    }
  ...
  {
    if (fraction == null) {
      throw MathRuntimeException.createIllegalArgumentException("null fraction", new Object[0]);
    }
    if (numerator == 0) {
    ...
    if (w.bitLength() > 31) {
      throw MathRuntimeException.createArithmeticException("overflow, numerator too large after multiply: {0}", new Object[] { w });
    }
  ...
  public Fraction divide(Fraction fraction)
  {
    ...
    if (numerator == 0) {
      throw MathRuntimeException.createArithmeticException("the fraction to divide by must not be zero: {0}/{1}", new Object[] { Integer.valueOf(numerator), Integer.valueOf(denominator) });
    }
  ...
  {
    if (denominator == 0) {
      throw MathRuntimeException.createArithmeticException("zero denominator in fraction {0}/{1}", new Object[] { Integer.valueOf(numerator), Integer.valueOf(denominator) });
    }
    if (numerator == 0) {
      return ZERO;
    }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.fraction.Fraction
