...
public class Lang
{
  ...
  private static final String LANGUAGE_RULES_RN = "com/amazon/ws/emr/hadoop/fs/shaded/org/apache/commons/codec/language/bm/%s_lang.txt";
  ...
  static
  {
    for (NameType s : NameType.values()) {
      Langs.put(s, loadFromResource(String.format("com/amazon/ws/emr/hadoop/fs/shaded/org/apache/commons/codec/language/bm/%s_lang.txt", new Object[] { s.getName() }), Languages.getInstance(s)));
    }
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.codec.language.bm.Lang
