...
public class TypeUtils
{
  ...
  private static Type[] unrollBounds(Map<TypeVariable<?>, Type> typeArguments, Type[] bounds)
  {
    ...
    for (int i = 0; i < result.length; i++)
    {
      ...
      if (unrolled == null) {
        result = (Type[])ArrayUtils.remove(result, i--);
      } else {
        result[i] = unrolled;
      }
    }
  ...
  {
    return new GenericArrayTypeImpl((Type)Validate.notNull(componentType, "componentType is null", new Object[0]), null);
  }
  ...
  public static String toLongString(TypeVariable<?> var)
  {
    ...
    return ':' + typeVariableToString(var);
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.lang3.reflect.TypeUtils
