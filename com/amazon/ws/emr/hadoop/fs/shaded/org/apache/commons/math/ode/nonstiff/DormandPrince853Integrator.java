  ...
  extends EmbeddedRungeKuttaIntegrator
{
  ...
  private static final double[] STATIC_C = { (12.0D - 2.0D * Math.sqrt(6.0D)) / 135.0D, (6.0D - Math.sqrt(6.0D)) / 45.0D, (6.0D - Math.sqrt(6.0D)) / 30.0D, (6.0D + Math.sqrt(6.0D)) / 30.0D, 0.3333333333333333D, 0.25D, 0.3076923076923077D, 0.6512820512820513D, 0.6D, 0.8571428571428571D, 1.0D, 1.0D };
  private static final double[][] STATIC_A = { { (12.0D - 2.0D * Math.sqrt(6.0D)) / 135.0D }, { (6.0D - Math.sqrt(6.0D)) / 180.0D, (6.0D - Math.sqrt(6.0D)) / 60.0D }, { (6.0D - Math.sqrt(6.0D)) / 120.0D, 0.0D, (6.0D - Math.sqrt(6.0D)) / 40.0D }, { (462.0D + 107.0D * Math.sqrt(6.0D)) / 3000.0D, 0.0D, (-402.0D - 197.0D * Math.sqrt(6.0D)) / 1000.0D, (168.0D + 73.0D * Math.sqrt(6.0D)) / 375.0D }, { 0.037037037037037035D, 0.0D, 0.0D, (16.0D + Math.sqrt(6.0D)) / 108.0D, (16.0D - Math.sqrt(6.0D)) / 108.0D }, { 0.037109375D, 0.0D, 0.0D, (118.0D + 23.0D * Math.sqrt(6.0D)) / 1024.0D, (118.0D - 23.0D * Math.sqrt(6.0D)) / 1024.0D, -0.017578125D }, { 0.03709200011850479D, 0.0D, 0.0D, (51544.0D + 4784.0D * Math.sqrt(6.0D)) / 371293.0D, (51544.0D - 4784.0D * Math.sqrt(6.0D)) / 371293.0D, -0.015319437748624402D, 0.008273789163814023D }, { 0.6241109587160757D, 0.0D, 0.0D, (-1.324889724104E12D - 3.18801444819E11D * Math.sqrt(6.0D)) / 6.265569375E11D, (-1.324889724104E12D + 3.18801444819E11D * Math.sqrt(6.0D)) / 6.265569375E11D, 27.59209969944671D, 20.154067550477894D, -43.48988418106996D }, { 0.47766253643826434D, 0.0D, 0.0D, (-4521408.0D - 1137963.0D * Math.sqrt(6.0D)) / 2937500.0D, (-4521408.0D + 1137963.0D * Math.sqrt(6.0D)) / 2937500.0D, 21.230051448181193D, 15.279233632882423D, -33.28821096898486D, -0.020331201708508627D }, { -0.9371424300859873D, 0.0D, 0.0D, (354216.0D + 94326.0D * Math.sqrt(6.0D)) / 112847.0D, (354216.0D - 94326.0D * Math.sqrt(6.0D)) / 112847.0D, -8.149787010746927D, -18.52006565999696D, 22.739487099350505D, 2.4936055526796523D, -3.0467644718982196D }, { 2.273310147516538D, 0.0D, 0.0D, (-3457480.0D - 960905.0D * Math.sqrt(6.0D)) / 551636.0D, (-3457480.0D + 960905.0D * Math.sqrt(6.0D)) / 551636.0D, -17.9589318631188D, 27.94888452941996D, -2.8589982771350235D, -8.87285693353063D, 12.360567175794303D, 0.6433927460157636D }, { 0.054293734116568765D, 0.0D, 0.0D, 0.0D, 0.0D, 4.450312892752409D, 1.8915178993145003D, -5.801203960010585D, 0.3111643669578199D, -0.1521609496625161D, 0.20136540080403034D, 0.04471061572777259D } };
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.ode.nonstiff.DormandPrince853Integrator
