...
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.util.CompositeFormat;
  ...
  extends CompositeFormat
{
  ...
  public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos)
  {
    ...
    if ((obj instanceof Complex)) {
      ...
      throw MathRuntimeException.createIllegalArgumentException("cannot format a {0} instance as a complex number", new Object[] { obj.getClass().getName() });
    }
    return ret;
  }
    ...
    throws ParseException
  {
    ...
    if (parsePosition.getIndex() == 0) {
      throw MathRuntimeException.createParseException(parsePosition.getErrorIndex(), "unparseable complex number: \"{0}\"", new Object[] { source });
    }
    return result;
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.complex.ComplexFormat
