  ...
  implements DateParser, Serializable
{
  ...
  private void init(Calendar definingCalendar)
  {
    ...
    strategies = ((Strategy[])collector.toArray(new Strategy[collector.size()]));
  ...
  public boolean equals(Object obj)
  {
    ...
    return (pattern.equals(pattern)) && (timeZone.equals(timeZone)) && (locale.equals(locale));
  }
  ...
  private Strategy getLocaleSpecificStrategy(int field, Calendar definingCalendar)
  {
    ...
    if (strategy == null)
    {
      strategy = field == 15 ? new TimeZoneStrategy(locale) : new TextStrategy(field, definingCalendar, locale);
    ...
    extends FastDateParser.Strategy
  {
    ...
    {
      FastDateParser.escapeRegex(regex, formatField, true);
      return false;
    }
  }
    ...
    extends FastDateParser.Strategy
  {
    ...
    TextStrategy(int field, Calendar definingCalendar, Locale locale)
    {
      super();
      this.field = field;
      keyValues = FastDateParser.getDisplayNames(field, definingCalendar, locale);
    }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.lang3.time.FastDateParser
