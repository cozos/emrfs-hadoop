  ...
  implements QRDecomposition
{
  ...
  public QRDecompositionImpl(RealMatrix matrix)
  {
    ...
    for (int minor = 0; minor < Math.min(m, n); minor++)
    {
      ...
      double a = qrtMinor[minor] > 0.0D ? -Math.sqrt(xNormSqr) : Math.sqrt(xNormSqr);
      rDiag[minor] = a;
      if (a != 0.0D)
      {
        qrtMinor[minor] -= a;
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.linear.QRDecompositionImpl
