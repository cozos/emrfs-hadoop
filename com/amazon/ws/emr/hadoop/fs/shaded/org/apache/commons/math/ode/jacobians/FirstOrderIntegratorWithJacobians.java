...
public class FirstOrderIntegratorWithJacobians
{
    ...
    throws IllegalArgumentException
  {
    ...
    if (arrayDimension != expected) {
      throw MathRuntimeException.createIllegalArgumentException("dimension mismatch {0} != {1}", new Object[] { Integer.valueOf(arrayDimension), Integer.valueOf(expected) });
    }
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians
