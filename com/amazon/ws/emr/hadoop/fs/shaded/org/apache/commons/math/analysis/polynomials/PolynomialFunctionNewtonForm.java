  ...
  implements UnivariateRealFunction
{
    ...
    throws IllegalArgumentException
  {
    ...
    if (a.length != c.length + 1) {
      throw MathRuntimeException.createIllegalArgumentException("array sizes should have difference 1 ({0} != {1} + 1)", new Object[] { Integer.valueOf(a.length), Integer.valueOf(c.length) });
    }
  }
}

/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.analysis.polynomials.PolynomialFunctionNewtonForm
