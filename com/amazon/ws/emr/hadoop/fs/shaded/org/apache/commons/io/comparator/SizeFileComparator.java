  ...
  implements Serializable
{
  ...
  public int compare(File file1, File file2)
  {
    ...
    if (file1.isDirectory()) {
      size1 = (sumDirectoryContents) && (file1.exists()) ? FileUtils.sizeOfDirectory(file1) : 0L;
    } else {
      size1 = file1.length();
    }
    long size2 = 0L;
    if (file2.isDirectory()) {
      size2 = (sumDirectoryContents) && (file2.exists()) ? FileUtils.sizeOfDirectory(file2) : 0L;
    } else {
      size2 = file2.length();
    }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.io.comparator.SizeFileComparator
