...
public class URLEncodedUtils
{
  ...
  public static void parse(List<NameValuePair> parameters, Scanner scanner, String parameterSepartorPattern, String charset)
  {
    ...
    while (scanner.hasNext())
    {
      ...
      if (i != -1)
      {
        String name = decodeFormFields(token.substring(0, i).trim(), charset);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.client.utils.URLEncodedUtils
