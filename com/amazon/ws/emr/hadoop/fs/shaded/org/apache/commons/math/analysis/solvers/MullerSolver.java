  ...
  extends UnivariateRealSolverImpl
{
    ...
    throws MaxIterationsExceededException, FunctionEvaluationException
  {
    ...
    for (int i = 1; i <= maximalIterationCount; i++)
    {
      ...
      double xplus = x1 + -2.0D * y1 / (c1 + Math.sqrt(delta));
      double xminus = x1 + -2.0D * y1 / (c1 - Math.sqrt(delta));
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.analysis.solvers.MullerSolver
