    ...
    throws ConvergenceException, FunctionEvaluationException
  {
    ...
    for (int j = 1; j < lastNaN; j++)
    {
      ...
      if (((goalType == GoalType.MAXIMIZE ? 1 : 0) ^ (currY < prevY ? 1 : 0)) != 0)
      {
        ...
        while (i >= 0)
        {
          if (((goalType == GoalType.MAXIMIZE ? 1 : 0) ^ (currY < mIY ? 1 : 0)) == 0) {
            break;
          }
          optima[(i + 1)] = mIX;
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.optimization.MultiStartUnivariateRealOptimizer
