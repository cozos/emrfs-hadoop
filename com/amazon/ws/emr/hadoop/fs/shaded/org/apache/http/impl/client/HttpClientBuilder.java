...
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.client.protocol.RequestExpectContinue;
...
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.conn.ssl.DefaultHostnameVerifier;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.conn.ssl.SSLConnectionSocketFactory;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.conn.ssl.X509HostnameVerifier;
...
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.impl.conn.DefaultProxyRoutePlanner;
...
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.impl.conn.SystemDefaultRoutePlanner;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.impl.execchain.BackoffStrategyExec;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.impl.execchain.ClientExecChain;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.impl.execchain.MainClientExec;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.impl.execchain.ProtocolExec;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.impl.execchain.RedirectExec;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.impl.execchain.RetryExec;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.impl.execchain.ServiceUnavailableRetryExec;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.protocol.HttpProcessor;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.protocol.HttpProcessorBuilder;
...
public class HttpClientBuilder
{
  ...
  public CloseableHttpClient build()
  {
    ...
    if (userAgentCopy == null)
    {
      ...
      if (userAgentCopy == null) {
        userAgentCopy = VersionInfo.getUserAgent("Apache-HttpClient", "com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.client", getClass());
      }
    }
    ...
    if (!connManagerShared)
    {
      ...
      {
        final IdleConnectionEvictor connectionEvictor = new IdleConnectionEvictor(cm, maxIdleTime > 0L ? maxIdleTime : 10L, maxIdleTimeUnit != null ? maxIdleTimeUnit : TimeUnit.SECONDS, maxIdleTime, maxIdleTimeUnit);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.impl.client.HttpClientBuilder
