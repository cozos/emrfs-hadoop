...
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.entity.AbstractHttpEntity;
...
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.entity.FileEntity;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.entity.InputStreamEntity;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.entity.SerializableEntity;
...
public class EntityBuilder
{
  ...
  public HttpEntity build()
  {
    ...
    if (text != null)
    {
      e = new StringEntity(text, getContentOrDefault(ContentType.DEFAULT_TEXT));
    }
    else
    {
      AbstractHttpEntity e;
      if (binary != null)
      {
        e = new ByteArrayEntity(binary, getContentOrDefault(ContentType.DEFAULT_BINARY));
      }
      else
      {
        AbstractHttpEntity e;
        if (stream != null)
        {
          e = new InputStreamEntity(stream, -1L, getContentOrDefault(ContentType.DEFAULT_BINARY));
        }
        else
        {
          AbstractHttpEntity e;
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.client.entity.EntityBuilder
