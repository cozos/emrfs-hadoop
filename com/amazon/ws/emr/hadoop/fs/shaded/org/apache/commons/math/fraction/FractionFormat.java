  ...
  extends AbstractFormat
{
  ...
  public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos)
  {
    ...
    if ((obj instanceof Fraction)) {
      ...
      {
        throw MathRuntimeException.createIllegalArgumentException("cannot convert given object to a fraction number: {0}", new Object[] { ex.getLocalizedMessage() });
      }
    } else {
      throw MathRuntimeException.createIllegalArgumentException("cannot format given object as a fraction number", new Object[0]);
    }
    return ret;
  }
    ...
    throws ParseException
  {
    ...
    if (parsePosition.getIndex() == 0) {
      throw MathRuntimeException.createParseException(parsePosition.getErrorIndex(), "unparseable fraction number: \"{0}\"", new Object[] { source });
    }
    return result;
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.fraction.FractionFormat
