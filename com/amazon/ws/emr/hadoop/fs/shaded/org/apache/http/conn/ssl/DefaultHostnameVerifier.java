...
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.conn.util.DomainType;
  ...
  implements HostnameVerifier
{
  ...
  static void matchIPAddress(String host, List<SubjectName> subjectAlts)
    throws SSLException
  {
  ...
  static void matchIPv6Address(String host, List<SubjectName> subjectAlts)
    throws SSLException
  {
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.conn.ssl.DefaultHostnameVerifier
