package com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.lang3.math;
  ...
  implements Comparable<Fraction>
{
  ...
  private static int greatestCommonDivisor(int u, int v)
  {
    ...
    for (int k = 0; ((u & 0x1) == 0) && ((v & 0x1) == 0) && (k < 31); k++)
    {
      u /= 2;v /= 2;
    }
    if (k == 31) {
  ...
  public Fraction multiplyBy(Fraction fraction)
  {
    ...
    return getReducedFraction(mulAndCheck(numerator / d1, numerator / d2), mulPosAndCheck(denominator / d2, denominator / d1));
  }
    ...
    if (toProperString == null) {
      ...
      else if ((numerator > 0 ? -numerator : numerator) < -denominator)
      {
        ...
        if (properNumerator == 0) {
          ...
          toProperString = (32 + getProperWhole() + ' ' + properNumerator + '/' + getDenominator());
        }
      }
      else
      {
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.lang3.math.Fraction
