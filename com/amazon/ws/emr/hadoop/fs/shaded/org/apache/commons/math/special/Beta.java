    ...
    throws MathException
  {
    ...
    else
    {
      ...
      else
      {
        ...
        ret = Math.exp(a * Math.log(x) + b * Math.log(1.0D - x) - Math.log(a) - logBeta(a, b, epsilon, maxIterations)) * 1.0D / fraction.evaluate(x, epsilon, maxIterations);
      }
    }
    return ret;
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.special.Beta
