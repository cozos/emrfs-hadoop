...
public class ValueServer
{
    ...
    throws IOException
  {
    ...
    if ((str = filePointer.readLine()) == null)
    {
      ...
      resetReplayFile();
      if ((str = filePointer.readLine()) == null) {
        throw MathRuntimeException.createEOFException("URL {0} contains no data", new Object[] { valuesFileURL });
      }
    }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.random.ValueServer
