...
{
  private static final String NON_POLYNOMIAL_FUNCTION_MESSAGE = "function is not polynomial";
  private static final String NON_POSITIVE_DEGREE_MESSAGE = "polynomial degree must be positive: degree={0}";
  @Deprecated
    ...
    throws IllegalArgumentException
  {
    ...
    if ((f instanceof PolynomialFunction)) {
      ...
      throw MathRuntimeException.createIllegalArgumentException("function is not polynomial", new Object[0]);
    }
  }
    ...
    throws MaxIterationsExceededException, FunctionEvaluationException
  {
    ...
    if (n < 1) {
      throw MathRuntimeException.createIllegalArgumentException("polynomial degree must be positive: degree={0}", new Object[] { Integer.valueOf(n) });
    }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.analysis.solvers.LaguerreSolver
