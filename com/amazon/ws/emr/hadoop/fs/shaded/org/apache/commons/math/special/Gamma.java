...
public class Gamma
{
  ...
  public static double logGamma(double x)
  {
    ...
    else
    {
      ...
      double tmp = x + g + 0.5D;
      ret = (x + 0.5D) * Math.log(tmp) - tmp + HALF_LOG_2_PI + Math.log(sum / x);
    }
    return ret;
  }
  ...
  public static double digamma(double x)
  {
    ...
    if (x >= 49.0D)
    {
      ...
      return Math.log(x) - 0.5D / x - inv * (0.08333333333333333D + inv * (0.008333333333333333D - inv / 252.0D));
    }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.special.Gamma
