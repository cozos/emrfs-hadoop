...
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.util.OpenIntToFieldHashMap;
import com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.util.OpenIntToFieldHashMap.Iterator;
  ...
  implements FieldVector<T>, Serializable
{
  ...
  {
    if (getDimension() != n) {
      throw MathRuntimeException.createIllegalArgumentException("vector length mismatch: got {0} but expected {1}", new Object[] { Integer.valueOf(getDimension()), Integer.valueOf(n) });
    }
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.linear.SparseFieldVector
