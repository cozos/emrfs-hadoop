...
public class URIBuilder
{
  ...
  private String buildString()
  {
    ...
    else
    {
      ...
      if (encodedPath != null) {
        sb.append(normalizePath(encodedPath, sb.length() == 0));
      } else if (path != null) {
        sb.append(encodePath(normalizePath(path, sb.length() == 0)));
      }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.client.utils.URIBuilder
