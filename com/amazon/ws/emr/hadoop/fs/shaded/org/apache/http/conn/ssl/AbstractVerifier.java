  ...
  implements X509HostnameVerifier
{
    ...
    throws SSLException
  {
    ...
    verify(host, cn != null ? new String[] { cn } : null, (subjectAlts != null) && (!subjectAlts.isEmpty()) ? (String[])subjectAlts.toArray(new String[subjectAlts.size()]) : null);
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.http.conn.ssl.AbstractVerifier
