  ...
  static double getStirlingError(double z)
  {
    ...
    if (z < 15.0D)
    {
      ...
      if (Math.floor(z2) == z2) {
        ...
        ret = Gamma.logGamma(z + 1.0D) - (z + 0.5D) * Math.log(z) + z - HALF_LOG_2_PI;
      }
    }
    else
    {
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.org.apache.commons.math.distribution.SaddlePointExpansion
