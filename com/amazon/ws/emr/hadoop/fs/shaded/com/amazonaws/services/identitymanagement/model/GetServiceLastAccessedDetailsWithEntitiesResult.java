...
public class GetServiceLastAccessedDetailsWithEntitiesResult
  ...
  implements Serializable, Cloneable
{
  ...
  public List<EntityDetails> getEntityDetailsList()
  {
    if (entityDetailsList == null) {
      entityDetailsList = new SdkInternalList();
    }
  ...
  public void setEntityDetailsList(Collection<EntityDetails> entityDetailsList)
  {
    ...
    this.entityDetailsList = new SdkInternalList(entityDetailsList);
  }
  ...
  public GetServiceLastAccessedDetailsWithEntitiesResult withEntityDetailsList(EntityDetails... entityDetailsList)
  {
    if (this.entityDetailsList == null) {
      setEntityDetailsList(new SdkInternalList(entityDetailsList.length));
    }
  ...
  public boolean equals(Object obj)
  {
    ...
    if (!(obj instanceof GetServiceLastAccessedDetailsWithEntitiesResult)) {
      return false;
    }
    ...
    if (((other.getEntityDetailsList() == null ? 1 : 0) ^ (getEntityDetailsList() == null ? 1 : 0)) != 0) {
      return false;
    }
    if ((other.getEntityDetailsList() != null) && (!other.getEntityDetailsList().equals(getEntityDetailsList()))) {
      return false;
    }
  ...
  public int hashCode()
  {
    ...
    hashCode = 31 * hashCode + (getEntityDetailsList() == null ? 0 : getEntityDetailsList().hashCode());
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.identitymanagement.model.GetServiceLastAccessedDetailsWithEntitiesResult
