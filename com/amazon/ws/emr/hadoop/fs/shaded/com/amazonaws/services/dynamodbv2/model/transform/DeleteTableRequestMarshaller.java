...
@SdkInternalApi
public class DeleteTableRequestMarshaller
{
  ...
  public static DeleteTableRequestMarshaller getInstance()
  {
    return instance;
  }
  ...
  public void marshall(DeleteTableRequest deleteTableRequest, ProtocolMarshaller protocolMarshaller)
  {
    ...
    try
    {
      protocolMarshaller.marshall(deleteTableRequest.getTableName(), TABLENAME_BINDING);
    }
    catch (Exception e)
    {
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.dynamodbv2.model.transform.DeleteTableRequestMarshaller
