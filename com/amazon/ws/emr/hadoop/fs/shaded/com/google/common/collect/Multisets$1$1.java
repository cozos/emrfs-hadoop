  ...
  extends AbstractIterator<Multiset.Entry<E>>
{
  ...
  protected Multiset.Entry<E> computeNext()
  {
    if (val$iterator1.hasNext())
    {
      ...
      int count = Math.max(entry1.getCount(), this$0.val$multiset2.count(element));
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.collect.Multisets.1.1
