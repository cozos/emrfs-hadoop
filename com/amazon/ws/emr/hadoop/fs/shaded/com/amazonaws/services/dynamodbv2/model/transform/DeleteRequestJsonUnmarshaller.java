...
public class DeleteRequestJsonUnmarshaller
  implements Unmarshaller<DeleteRequest, JsonUnmarshallerContext>
{
    ...
    throws Exception
  {
    ...
    while (token != null)
    {
      if ((token == JsonToken.FIELD_NAME) || (token == JsonToken.START_OBJECT))
      {
        ...
        {
          context.nextToken();
          deleteRequest.setKey(new MapUnmarshaller(context.getUnmarshaller(String.class), 
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.dynamodbv2.model.transform.DeleteRequestJsonUnmarshaller
