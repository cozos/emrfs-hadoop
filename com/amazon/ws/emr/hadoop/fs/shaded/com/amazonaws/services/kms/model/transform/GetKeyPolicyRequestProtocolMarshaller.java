  ...
  implements Marshaller<Request<GetKeyPolicyRequest>, GetKeyPolicyRequest>
{
  ...
  public Request<GetKeyPolicyRequest> marshall(GetKeyPolicyRequest getKeyPolicyRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<GetKeyPolicyRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, getKeyPolicyRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.kms.model.transform.GetKeyPolicyRequestProtocolMarshaller
