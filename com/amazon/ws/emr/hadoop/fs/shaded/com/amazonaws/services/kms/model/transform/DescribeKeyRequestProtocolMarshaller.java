  ...
  implements Marshaller<Request<DescribeKeyRequest>, DescribeKeyRequest>
{
  ...
  public Request<DescribeKeyRequest> marshall(DescribeKeyRequest describeKeyRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<DescribeKeyRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, describeKeyRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.kms.model.transform.DescribeKeyRequestProtocolMarshaller
