  ...
  implements ListMultimap<K, V>
{
  ...
  {
    ImmutableList<V> list = (ImmutableList)map.get(key);
    ...
    throws IOException, ClassNotFoundException
  {
    ...
    for (int i = 0; i < keyCount; i++)
    {
      ...
      ((ImmutableMap.Builder)builder).put(key, ImmutableList.copyOf(array));
      tmpSize += valueCount;
    }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.collect.ImmutableListMultimap
