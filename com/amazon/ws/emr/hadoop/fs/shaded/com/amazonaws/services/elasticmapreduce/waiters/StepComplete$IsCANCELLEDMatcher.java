...
class StepComplete$IsCANCELLEDMatcher
  extends WaiterAcceptor<DescribeStepResult>
{
  ...
  private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathExpression[] { new JmesPathField("Step"), new JmesPathField("Status"), new JmesPathField("State") });
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.elasticmapreduce.waiters.StepComplete.IsCANCELLEDMatcher
