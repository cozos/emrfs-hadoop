 ...
 enum LocalCache$EntryFactory$6
{
  ...
  {
    return new LocalCache.WeakAccessEntry(keyReferenceQueue, key, hash, next);
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.cache.LocalCache.EntryFactory.6
