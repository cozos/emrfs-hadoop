...
@SdkInternalApi
public class AddInstanceFleetRequestProtocolMarshaller
  implements Marshaller<Request<AddInstanceFleetRequest>, AddInstanceFleetRequest>
{
  ...
  public AddInstanceFleetRequestProtocolMarshaller(SdkJsonProtocolFactory protocolFactory)
  {
  ...
  public Request<AddInstanceFleetRequest> marshall(AddInstanceFleetRequest addInstanceFleetRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<AddInstanceFleetRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, addInstanceFleetRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.elasticmapreduce.model.transform.AddInstanceFleetRequestProtocolMarshaller
