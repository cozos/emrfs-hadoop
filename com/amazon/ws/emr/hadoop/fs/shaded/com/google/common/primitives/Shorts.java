...
public final class Shorts
{
    ...
    implements RandomAccess, Serializable
  {
    ...
    {
      return ((target instanceof Short)) && (Shorts.indexOf(array, ((Short)target).shortValue(), start, end) != -1);
    }
    ...
    public int indexOf(Object target)
    {
      ...
      {
        int i = Shorts.indexOf(array, ((Short)target).shortValue(), start, end);
        if (i >= 0) {
          return i - start;
        }
      }
    ...
    public int lastIndexOf(Object target)
    {
      if ((target instanceof Short))
      {
        int i = Shorts.lastIndexOf(array, ((Short)target).shortValue(), start, end);
        if (i >= 0) {
          return i - start;
        }
      }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.primitives.Shorts
