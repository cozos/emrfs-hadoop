    ...
    try
    {
      ...
      new UnsafeAllocator()
      {
        public <T> T newInstance(Class<T> c)
          throws Exception
        {
          return (T)val$allocateInstance.invoke(unsafe, new Object[] { c });
        }
      };
    }
        ...
        try
        {
          ...
          new UnsafeAllocator()
          {
            public <T> T newInstance(Class<T> c)
              throws Exception
            {
              return (T)val$newInstance.invoke(null, new Object[] { c, Integer.valueOf(constructorId) });
            }
          };
        }
        catch (Exception ignored) {}
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.gson.internal.UnsafeAllocator
