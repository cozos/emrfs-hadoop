...
public final class TypeResolver
{
  ...
  private static void populateTypeMappings(Map<TypeVariableKey, Type> mappings, Type from, final Type to)
  {
    ...
    new TypeVisitor()
    {
      ...
      {
        val$mappings.put(new TypeResolver.TypeVariableKey(typeVariable), to);
      }
  ...
  private static <T> T expectArgument(Class<T> type, Object arg)
  {
    ...
    {
      String str1 = String.valueOf(String.valueOf(arg));String str2 = String.valueOf(String.valueOf(type.getSimpleName()));throw new IllegalArgumentException(10 + str1.length() + str2.length() + str1 + " is not a " + str2);
    }
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.reflect.TypeResolver
