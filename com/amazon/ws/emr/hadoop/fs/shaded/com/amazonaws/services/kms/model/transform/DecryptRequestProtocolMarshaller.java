  ...
  implements Marshaller<Request<DecryptRequest>, DecryptRequest>
{
  ...
  public Request<DecryptRequest> marshall(DecryptRequest decryptRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<DecryptRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, decryptRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.kms.model.transform.DecryptRequestProtocolMarshaller
