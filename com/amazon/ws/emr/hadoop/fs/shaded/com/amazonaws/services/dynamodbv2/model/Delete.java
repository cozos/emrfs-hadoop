...
import com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.dynamodbv2.model.transform.DeleteMarshaller;
  ...
  implements Serializable, Cloneable, StructuredPojo
{
  ...
  public Delete withKey(Map<String, AttributeValue> key)
  {
    setKey(key);
    return this;
  }
  ...
  public Delete withExpressionAttributeNames(Map<String, String> expressionAttributeNames)
  {
  ...
  public Delete withExpressionAttributeValues(Map<String, AttributeValue> expressionAttributeValues)
  {
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.dynamodbv2.model.Delete
