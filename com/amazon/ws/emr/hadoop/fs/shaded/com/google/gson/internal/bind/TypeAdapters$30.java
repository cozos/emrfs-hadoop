  ...
  implements TypeAdapterFactory
{
  ...
  public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken)
  {
    ...
    return (rawType == val$base) || (rawType == val$sub) ? val$typeAdapter : null;
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.gson.internal.bind.TypeAdapters.30
