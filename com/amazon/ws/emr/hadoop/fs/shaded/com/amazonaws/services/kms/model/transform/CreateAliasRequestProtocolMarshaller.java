  ...
  implements Marshaller<Request<CreateAliasRequest>, CreateAliasRequest>
{
  ...
  public Request<CreateAliasRequest> marshall(CreateAliasRequest createAliasRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<CreateAliasRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, createAliasRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.kms.model.transform.CreateAliasRequestProtocolMarshaller
