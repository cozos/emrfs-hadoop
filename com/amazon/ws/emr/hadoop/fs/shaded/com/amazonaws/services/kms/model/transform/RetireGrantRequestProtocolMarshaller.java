  ...
  implements Marshaller<Request<RetireGrantRequest>, RetireGrantRequest>
{
  private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.AWS_JSON).requestUri("/")
    .httpMethodName(HttpMethodName.POST).hasExplicitPayloadMember(false).hasPayloadMembers(true).operationIdentifier("TrentService.RetireGrant")
  ...
  public Request<RetireGrantRequest> marshall(RetireGrantRequest retireGrantRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<RetireGrantRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, retireGrantRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.kms.model.transform.RetireGrantRequestProtocolMarshaller
