...
import com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.elasticmapreduce.model.transform.InstanceStateChangeReasonMarshaller;
  ...
  implements Serializable, Cloneable, StructuredPojo
{
  ...
  public boolean equals(Object obj)
  {
    ...
    if (!(obj instanceof InstanceStateChangeReason)) {
      return false;
    }
  ...
  {
    InstanceStateChangeReasonMarshaller.getInstance().marshall(this, protocolMarshaller);
  }
}

/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.elasticmapreduce.model.InstanceStateChangeReason
