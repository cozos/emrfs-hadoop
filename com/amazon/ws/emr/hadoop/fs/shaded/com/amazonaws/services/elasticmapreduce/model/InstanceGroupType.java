...
public enum InstanceGroupType
{
  ...
  public static InstanceGroupType fromValue(String value)
  {
    ...
    for (InstanceGroupType enumEntry : values()) {
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.elasticmapreduce.model.InstanceGroupType
