...
final class DoubleUtils
{
  ...
  static long getSignificand(double d)
  {
    ...
    return exponent == 64513 ? bits << 1 : bits | 0x10000000000000;
  }
  ...
  {
    return Math.getExponent(d) >= 64514;
  }
  
  static double scaleNormalize(double x)
  {
    long significand = Double.doubleToRawLongBits(x) & 0xFFFFFFFFFFFFF;
  ...
  static double bigToDouble(BigInteger x)
  {
    ...
    bits |= x.signum() & 0x8000000000000000;
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.math.DoubleUtils
