...
import com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.collect.ObjectArrays;
  ...
  public <T> T newProxy(final T target, Class<T> interfaceType, final long timeoutDuration, TimeUnit timeoutUnit)
  {
    ...
    InvocationHandler handler = new InvocationHandler()
    {
        ...
        throws Throwable
      {
        ...
        return callWithTimeout(callable, timeoutDuration, interruptibleMethods, val$interruptibleMethods.contains(method));
      }
    };
    return (T)newProxy(interfaceType, handler);
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.util.concurrent.SimpleTimeLimiter
