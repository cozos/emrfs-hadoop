...
public class StepSummaryJsonUnmarshaller
  implements Unmarshaller<StepSummary, JsonUnmarshallerContext>
{
    ...
    throws Exception
  {
    ...
    while (token != null)
    {
      if ((token == JsonToken.FIELD_NAME) || (token == JsonToken.START_OBJECT))
      {
        ...
        {
          context.nextToken();
          stepSummary.setId((String)context.getUnmarshaller(String.class).unmarshall(context));
        }
        if (context.testExpression("Name", targetDepth))
        {
          context.nextToken();
          stepSummary.setName((String)context.getUnmarshaller(String.class).unmarshall(context));
        }
        ...
        {
          context.nextToken();
          stepSummary.setActionOnFailure((String)context.getUnmarshaller(String.class).unmarshall(context));
        }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.elasticmapreduce.model.transform.StepSummaryJsonUnmarshaller
