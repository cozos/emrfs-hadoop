  ...
  extends AbstractRangeSet<C>
{
  ...
  public void remove(Range<C> rangeToRemove)
  {
    ...
    if (entryBelowLB != null)
    {
      ...
      {
        if ((rangeToRemove.hasUpperBound()) && (upperBound.compareTo(upperBound) >= 0)) {
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.collect.TreeRangeSet
