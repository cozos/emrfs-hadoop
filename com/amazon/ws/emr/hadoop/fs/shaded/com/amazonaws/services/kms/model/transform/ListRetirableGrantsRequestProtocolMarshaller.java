  ...
  implements Marshaller<Request<ListRetirableGrantsRequest>, ListRetirableGrantsRequest>
{
  private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.AWS_JSON).requestUri("/")
    ...
    .operationIdentifier("TrentService.ListRetirableGrants").serviceName("AWSKMS").build();
  ...
  public Request<ListRetirableGrantsRequest> marshall(ListRetirableGrantsRequest listRetirableGrantsRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<ListRetirableGrantsRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, listRetirableGrantsRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.kms.model.transform.ListRetirableGrantsRequestProtocolMarshaller
