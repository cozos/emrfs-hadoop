...
@SdkInternalApi
public class CreateSecurityConfigurationRequestProtocolMarshaller
  implements Marshaller<Request<CreateSecurityConfigurationRequest>, CreateSecurityConfigurationRequest>
{
  ...
  public CreateSecurityConfigurationRequestProtocolMarshaller(SdkJsonProtocolFactory protocolFactory)
  {
  ...
  public Request<CreateSecurityConfigurationRequest> marshall(CreateSecurityConfigurationRequest createSecurityConfigurationRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<CreateSecurityConfigurationRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, createSecurityConfigurationRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.elasticmapreduce.model.transform.CreateSecurityConfigurationRequestProtocolMarshaller
