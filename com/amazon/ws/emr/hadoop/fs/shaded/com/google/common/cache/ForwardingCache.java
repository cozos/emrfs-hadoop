  ...
  implements Cache<K, V>
{
  ...
  {
    return (V)delegate().getIfPresent(key);
  }
  
  public V get(K key, Callable<? extends V> valueLoader)
    throws ExecutionException
  {
    return (V)delegate().get(key, valueLoader);
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.cache.ForwardingCache
