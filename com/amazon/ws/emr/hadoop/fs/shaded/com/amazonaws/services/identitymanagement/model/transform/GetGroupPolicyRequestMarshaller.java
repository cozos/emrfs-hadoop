  ...
  implements Marshaller<Request<GetGroupPolicyRequest>, GetGroupPolicyRequest>
{
  public Request<GetGroupPolicyRequest> marshall(GetGroupPolicyRequest getGroupPolicyRequest)
  {
    ...
    Request<GetGroupPolicyRequest> request = new DefaultRequest(getGroupPolicyRequest, "AmazonIdentityManagement");
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.identitymanagement.model.transform.GetGroupPolicyRequestMarshaller
