  ...
  implements Marshaller<Request<CreateGrantRequest>, CreateGrantRequest>
{
  ...
  public Request<CreateGrantRequest> marshall(CreateGrantRequest createGrantRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<CreateGrantRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, createGrantRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.kms.model.transform.CreateGrantRequestProtocolMarshaller
