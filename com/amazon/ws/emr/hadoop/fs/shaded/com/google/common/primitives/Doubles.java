...
public final class Doubles
{
    ...
    implements RandomAccess, Serializable
  {
    ...
    {
      return ((target instanceof Double)) && (Doubles.indexOf(array, ((Double)target).doubleValue(), start, end) != -1);
    }
  ...
  private static Pattern fpPattern()
  {
    ...
    String str1 = String.valueOf(String.valueOf(hex));String completeHex = 25 + str1.length() + "0[xX]" + str1 + "[pP][+-]?\\d++[fFdD]?";
    String str2 = String.valueOf(String.valueOf(completeDec));String str3 = String.valueOf(String.valueOf(completeHex));String fpPattern = 23 + str2.length() + str3.length() + "[+-]?(?:NaN|Infinity|" + str2 + "|" + str3 + ")";
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.primitives.Doubles
