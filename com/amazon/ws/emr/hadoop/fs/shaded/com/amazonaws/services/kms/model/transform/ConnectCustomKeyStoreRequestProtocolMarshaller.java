  ...
  implements Marshaller<Request<ConnectCustomKeyStoreRequest>, ConnectCustomKeyStoreRequest>
{
  private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.AWS_JSON).requestUri("/")
    ...
    .operationIdentifier("TrentService.ConnectCustomKeyStore").serviceName("AWSKMS").build();
  ...
  public Request<ConnectCustomKeyStoreRequest> marshall(ConnectCustomKeyStoreRequest connectCustomKeyStoreRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<ConnectCustomKeyStoreRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, connectCustomKeyStoreRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.kms.model.transform.ConnectCustomKeyStoreRequestProtocolMarshaller
