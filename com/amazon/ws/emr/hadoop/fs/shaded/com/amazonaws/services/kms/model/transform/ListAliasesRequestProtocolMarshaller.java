  ...
  implements Marshaller<Request<ListAliasesRequest>, ListAliasesRequest>
{
  ...
  public Request<ListAliasesRequest> marshall(ListAliasesRequest listAliasesRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<ListAliasesRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, listAliasesRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.kms.model.transform.ListAliasesRequestProtocolMarshaller
