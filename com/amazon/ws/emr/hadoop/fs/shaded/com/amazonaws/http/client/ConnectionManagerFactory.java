...
@Beta
public abstract interface ConnectionManagerFactory<T>
{
  public abstract T create(HttpClientSettings paramHttpClientSettings);
}

/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.http.client.ConnectionManagerFactory
