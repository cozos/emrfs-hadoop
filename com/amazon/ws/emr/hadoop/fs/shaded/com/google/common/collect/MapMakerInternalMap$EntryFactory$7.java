 ...
 enum MapMakerInternalMap$EntryFactory$7
{
  ...
  {
    return new MapMakerInternalMap.WeakEvictableEntry(keyReferenceQueue, key, hash, next);
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.collect.MapMakerInternalMap.EntryFactory.7
