...
import com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.hash.Hashing;
import com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.io.ByteArrayDataInput;
import com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.io.ByteStreams;
...
public final class InetAddresses
{
  ...
  private static byte[] textToNumericFormatV6(String ipString)
  {
    ...
    if (skipIndex >= 0)
    {
      int partsHi = skipIndex;
      int partsLo = parts.length - skipIndex - 1;
      if (parts[0].length() == 0)
      {
        partsHi--;
        if (partsHi != 0) {
  ...
  private static String convertDottedQuadToHex(String ipString)
  {
    ...
    String str1 = String.valueOf(String.valueOf(initialPart));String str2 = String.valueOf(String.valueOf(penultimate));String str3 = String.valueOf(String.valueOf(ultimate));return 1 + str1.length() + str2.length() + str3.length() + str1 + str2 + ":" + str3;
  }
  ...
  public static String toAddrString(InetAddress ip)
  {
    ...
    for (int i = 0; i < hextets.length; i++) {
      hextets[i] = Ints.fromBytes(0, 0, bytes[(2 * i)], bytes[(2 * i + 1)]);
    }
  ...
  public static String toUriString(InetAddress ip)
  {
    ...
    {
      String str = String.valueOf(String.valueOf(toAddrString(ip)));return 2 + str.length() + "[" + str + "]";
    }
  ...
  public static InetAddress forUriString(String hostAddr)
  {
    ...
    {
      String ipString = hostAddr.substring(1, hostAddr.length() - 1);
      expectBytes = 16;
    }
    else
    {
  ...
  public static InetAddress decrement(InetAddress address)
  {
    ...
    Preconditions.checkArgument(i >= 0, "Decrementing %s would wrap.", new Object[] { address }); int 
    
      tmp55_54 = i; byte[] tmp55_53 = addr;tmp55_53[tmp55_54] = ((byte)(tmp55_53[tmp55_54] - 1));
    return bytesToInetAddress(addr);
  }
  ...
  public static InetAddress increment(InetAddress address)
  {
    ...
    Preconditions.checkArgument(i >= 0, "Incrementing %s would wrap.", new Object[] { address }); int 
    
      tmp56_55 = i; byte[] tmp56_54 = addr;tmp56_54[tmp56_55] = ((byte)(tmp56_54[tmp56_55] + 1));
    return bytesToInetAddress(addr);
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.net.InetAddresses
