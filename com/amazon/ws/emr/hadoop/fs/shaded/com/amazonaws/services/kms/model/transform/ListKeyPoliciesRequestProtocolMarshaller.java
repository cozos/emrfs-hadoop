  ...
  implements Marshaller<Request<ListKeyPoliciesRequest>, ListKeyPoliciesRequest>
{
  ...
  public Request<ListKeyPoliciesRequest> marshall(ListKeyPoliciesRequest listKeyPoliciesRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<ListKeyPoliciesRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, listKeyPoliciesRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.kms.model.transform.ListKeyPoliciesRequestProtocolMarshaller
