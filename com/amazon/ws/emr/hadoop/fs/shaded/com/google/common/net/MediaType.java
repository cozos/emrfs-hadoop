...
import com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.collect.ImmutableListMultimap;
import com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.collect.ImmutableListMultimap.Builder;
...
public final class MediaType
{
  ...
  public Optional<Charset> charset()
  {
    ...
    String str = String.valueOf(String.valueOf(charsetValues));throw new IllegalStateException(33 + str.length() + "Multiple charset values defined: " + str);
  }
  ...
  public static MediaType parse(String input)
  {
    ...
    try
    {
      ...
      subtype = tokenizer.consumeToken(TOKEN_MATCHER);
    ...
    {
      String subtype = String.valueOf(String.valueOf(input));throw new IllegalArgumentException(18 + subtype.length() + "Could not parse '" + subtype + "'", e);
    }
  }
  ...
  public boolean equals(@Nullable Object obj)
  {
    ...
    if ((obj instanceof MediaType))
    {
      ...
      return (type.equals(type)) && (subtype.equals(subtype)) && (parametersAsMap().equals(that.parametersAsMap()));
    }
    return false;
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.net.MediaType
