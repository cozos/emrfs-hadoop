    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (oldValue != 0) {
          ...
          {
            int i = occurrences;int j = oldValue;throw new IllegalArgumentException(65 + "Overflow adding " + i + " occurrences to a count of " + j);
          }
        }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.collect.ConcurrentHashMultiset
