  ...
  implements Serializable
{
  ...
  {
    String str = String.valueOf(String.valueOf(ordering));return 13 + str.length() + str + ".nullsFirst()";
  }
}

/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.collect.NullsFirstOrdering
