  ...
  implements Marshaller<Request<EncryptRequest>, EncryptRequest>
{
  private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.AWS_JSON).requestUri("/")
    .httpMethodName(HttpMethodName.POST).hasExplicitPayloadMember(false).hasPayloadMembers(true).operationIdentifier("TrentService.Encrypt")
  ...
  public Request<EncryptRequest> marshall(EncryptRequest encryptRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<EncryptRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, encryptRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.kms.model.transform.EncryptRequestProtocolMarshaller
