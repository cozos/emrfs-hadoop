  ...
  implements Marshaller<Request<CreatePolicyVersionRequest>, CreatePolicyVersionRequest>
{
  public Request<CreatePolicyVersionRequest> marshall(CreatePolicyVersionRequest createPolicyVersionRequest)
  {
    ...
    Request<CreatePolicyVersionRequest> request = new DefaultRequest(createPolicyVersionRequest, "AmazonIdentityManagement");
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.identitymanagement.model.transform.CreatePolicyVersionRequestMarshaller
