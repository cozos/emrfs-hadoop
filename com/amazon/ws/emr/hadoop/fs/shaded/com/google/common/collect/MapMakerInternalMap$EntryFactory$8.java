 ...
 enum MapMakerInternalMap$EntryFactory$8
{
  ...
  {
    return new MapMakerInternalMap.WeakExpirableEvictableEntry(keyReferenceQueue, key, hash, next);
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.collect.MapMakerInternalMap.EntryFactory.8
