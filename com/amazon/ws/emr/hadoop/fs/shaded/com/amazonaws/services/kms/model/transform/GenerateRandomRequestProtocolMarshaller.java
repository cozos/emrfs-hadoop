  ...
  implements Marshaller<Request<GenerateRandomRequest>, GenerateRandomRequest>
{
  ...
  public Request<GenerateRandomRequest> marshall(GenerateRandomRequest generateRandomRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<GenerateRandomRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, generateRandomRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.kms.model.transform.GenerateRandomRequestProtocolMarshaller
