  ...
  implements Marshaller<Request<UpdateKeyDescriptionRequest>, UpdateKeyDescriptionRequest>
{
  private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.AWS_JSON).requestUri("/")
    ...
    .operationIdentifier("TrentService.UpdateKeyDescription").serviceName("AWSKMS").build();
  ...
  public Request<UpdateKeyDescriptionRequest> marshall(UpdateKeyDescriptionRequest updateKeyDescriptionRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<UpdateKeyDescriptionRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, updateKeyDescriptionRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.kms.model.transform.UpdateKeyDescriptionRequestProtocolMarshaller
