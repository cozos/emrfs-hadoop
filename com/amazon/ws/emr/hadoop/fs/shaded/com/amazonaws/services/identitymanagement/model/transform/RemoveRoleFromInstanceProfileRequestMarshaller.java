...
public class RemoveRoleFromInstanceProfileRequestMarshaller
  implements Marshaller<Request<RemoveRoleFromInstanceProfileRequest>, RemoveRoleFromInstanceProfileRequest>
{
  public Request<RemoveRoleFromInstanceProfileRequest> marshall(RemoveRoleFromInstanceProfileRequest removeRoleFromInstanceProfileRequest)
  {
    ...
    Request<RemoveRoleFromInstanceProfileRequest> request = new DefaultRequest(removeRoleFromInstanceProfileRequest, "AmazonIdentityManagement");
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.identitymanagement.model.transform.RemoveRoleFromInstanceProfileRequestMarshaller
