  ...
  extends ImmutableSortedSet<C>
{
  ...
  public static <C extends Comparable> ContiguousSet<C> create(Range<C> range, DiscreteDomain<C> domain)
  {
    ...
    boolean empty = (effectiveRange.isEmpty()) || (Range.compareOrThrow(lowerBound.leastValueAbove(domain), upperBound.greatestValueBelow(domain)) > 0);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.collect.ContiguousSet
