  ...
  implements Marshaller<Request<GetRoleRequest>, GetRoleRequest>
{
  public Request<GetRoleRequest> marshall(GetRoleRequest getRoleRequest)
  {
    ...
    Request<GetRoleRequest> request = new DefaultRequest(getRoleRequest, "AmazonIdentityManagement");
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.identitymanagement.model.transform.GetRoleRequestMarshaller
