...
public final class InternetDomainName
{
  ...
  InternetDomainName(String name)
  {
    ...
    Preconditions.checkArgument(parts.size() <= 127, "Domain has too many parts: '%s'", new Object[] { name });
    
    Preconditions.checkArgument(validateSyntax(parts), "Not a valid domain name: '%s'", new Object[] { name });
  ...
  {
    String str1 = String.valueOf(String.valueOf((String)Preconditions.checkNotNull(leftParts)));String str2 = String.valueOf(String.valueOf(name));return from(1 + str1.length() + str2.length() + str1 + "." + str2);
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.net.InternetDomainName
