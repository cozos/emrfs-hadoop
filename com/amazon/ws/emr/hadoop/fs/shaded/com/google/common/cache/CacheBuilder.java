...
import com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.base.Suppliers;
...
public final class CacheBuilder<K, V>
{
  ...
  {
    Preconditions.checkState(valueEquivalence == null, "value equivalence was already set to %s", new Object[] { valueEquivalence });
  ...
  {
    Preconditions.checkState(maximumSize == -1L, "maximum size was already set to %s", new Object[] { Long.valueOf(maximumSize) });
    
    Preconditions.checkState(maximumWeight == -1L, "maximum weight was already set to %s", new Object[] { Long.valueOf(maximumWeight) });
  ...
  public <K1 extends K, V1 extends V> CacheBuilder<K1, V1> weigher(Weigher<? super K1, ? super V1> weigher)
  {
    ...
    if (strictParsing) {
      Preconditions.checkState(maximumSize == -1L, "weigher can not be combined with maximum size", new Object[] { Long.valueOf(maximumSize) });
    }
  ...
  public CacheBuilder<K, V> refreshAfterWrite(long duration, TimeUnit unit)
  {
    ...
    Preconditions.checkState(refreshNanos == -1L, "refresh was already set to %s ns", new Object[] { Long.valueOf(refreshNanos) });
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.cache.CacheBuilder
