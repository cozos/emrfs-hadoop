  ...
  implements Marshaller<Request<PutKeyPolicyRequest>, PutKeyPolicyRequest>
{
  ...
  public Request<PutKeyPolicyRequest> marshall(PutKeyPolicyRequest putKeyPolicyRequest)
  {
    ...
    try
    {
      ProtocolRequestMarshaller<PutKeyPolicyRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING, putKeyPolicyRequest);
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.amazonaws.services.kms.model.transform.PutKeyPolicyRequestProtocolMarshaller
