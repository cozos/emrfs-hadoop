...
public final class Preconditions
{
  ...
  private static String badElementIndex(int index, int size, String desc)
  {
    ...
    if (size < 0)
    {
      int i = size;throw new IllegalArgumentException(26 + "negative size: " + i);
    }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.base.Preconditions
