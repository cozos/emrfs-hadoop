  ...
  implements MapMakerInternalMap.ReferenceEntry<K, V>
{
  ...
  MapMakerInternalMap$SoftEntry(ReferenceQueue<K> queue, K key, int hash, @Nullable MapMakerInternalMap.ReferenceEntry<K, V> next)
  {
    super(key, queue);
    this.hash = hash;
    this.next = next;
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.shaded.com.google.common.collect.MapMakerInternalMap.SoftEntry
