  ...
  implements Iterable<Triple<S3ObjectSummary, String, Entity>>
{
  ...
  {
    return new CombinedS3DynamoIterator(s3ObjectListing.iterator(), entityIterable.iterator());
  }
...
/* Location:
 * Qualified Name:     com.amazon.ws.emr.hadoop.fs.consistency.CombinedS3DynamoListing
